                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="detail-box">
                            ...
                            <p>
                                Hãy gửi đến người bạn thương một chiếc áo thật đẹp, thật phong cách nhưng lại không kém
                                phần thời trang.
                            </p>
                            <div class="btn-box">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 px-0">
                    <form id="formlienhe" name="formlienhe" method="post">
                        ...
                        <div class="d-flex ">
                            <input class="detail-box" type="submit" name="ph" value="Gửi phản hồi"
                                style="background-color: #FF0000; color: white; border: none; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; border-radius: 5px;" />
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="box">
                            ...
                            <p>
                                Với mong muốn vươn lên đứng đầu chúng tôi luôn đảm bảo những sản phẩm được gửi đến tay
                                khách hàng là hoàn hảo nhất.
                            </p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="box">
                            ...
                            <p>
                                Bằng các sử dụng 100% sợi cotton thiên nhiên, chúng tôi hướng đến một môi trường xanh,
                                sạch, đẹp nhưng lại vô cùng mềm mại dễ chịu khi sử dụng.
                            </p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="box">
                            ...
                            <p>
                                Không chỉ là một hãng thời trang, chúng tôi còn là một phòng thí nghiệm - nơi nghiên cứu
                                ra nguồn năng lượng bất tận mang tên "Sáng tạo" và "Đổi mới".
                            </p>
                        </div>
                    </div>
                </div>
