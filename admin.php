                    ...
                    <div class="detail_infomation">
                        <div class="left_info">
                            <?php
                                ...
                                $sql_select_money_quarterly ="SELECT SUM(tien) AS tong_tien 
                                FROM tb_donhang 
                                ...
                                $sql_select_money_month ="SELECT SUM(tien) AS tong_tien 
                                FROM tb_donhang 
                                ...
                                $sql_select_money_day ="SELECT SUM(tien) AS tong_tien 
                                FROM tb_donhang 
                                WHERE day(ngaylap) = 1 ";
